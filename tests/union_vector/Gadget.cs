...
public class GadgetUnion {
  ...
  public static int Pack(ref Fivemid.FiveFlat.FlatBufferBuilder builder, GadgetUnion _o) {
    switch (_o.Type) {
      default: return 0;
      case Gadget.FallingTub: return FallingTub.Pack(ref builder, _o.AsFallingTub()).Value;
      case Gadget.HandFan: return HandFan.Pack(ref builder, _o.AsHandFan()).Value;
    }
  }
}
