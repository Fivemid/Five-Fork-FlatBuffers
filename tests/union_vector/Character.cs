...
public class CharacterUnion {
  ...
  public static int Pack(ref Fivemid.FiveFlat.FlatBufferBuilder builder, CharacterUnion _o) {
    switch (_o.Type) {
      default: return 0;
      case Character.MuLan: return Attacker.Pack(ref builder, _o.AsMuLan()).Value;
      case Character.Rapunzel: return Rapunzel.Pack(ref builder, _o.AsRapunzel()).Value;
      case Character.Belle: return BookReader.Pack(ref builder, _o.AsBelle()).Value;
      case Character.BookFan: return BookReader.Pack(ref builder, _o.AsBookFan()).Value;
